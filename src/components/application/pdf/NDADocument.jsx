...
export default function NDADocument({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            {/* Clause 1.1 */}
            <div className="mb-3 pl-4 leading-[1.4] text-justify">
        ...
        >
            ...
            <div className="mb-4 pl-4 leading-[1.4] text-justify ml-6">
            ...
            {/* Clause 10.4 */}
            <div className="mb-4 pl-4 pl-4 leading-[1.4] text-justify">
            ...
            {/* Clause 11.2 */}
            <div className="mb-6 pl-4 leading-[1.4] text-justify">
