    ...
    return (
        ...
        >
            ...
            <div className="mb-4 leading-[1.4]">
                <p className="indent-8">สัญญาฉบับนี้ทำขึ้นที่ บริษัท เค แอนด์ โอ ซิสเต็มส์ แอนด์ คอนซัลติ้ง จำกัด</p>
                <p className="indent-8">เมื่อวันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${formData.contractDate ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.contractDate && { minHeight: '1.2em' }) }}>{formData.contractDate || ''}</span></p>
            </div>
        ...
        >
            ...
            {/* Clause 2 */}
            <div className="mb-4 leading-[1.4]">
                <p className="font-bold mb-2">ข้อ 2  ข้อมูลที่ต้องรักษาความลับ</p>
            </div>

            {/* Clause 2.1 */}
            <div className="mb-3 leading-[1.4] text-justify">
                <p>2.1 "ข้อมูลความลับ" หมายถึง ข้อมูลใด ๆ ไม่ว่าจะอยู่ในรูปแบบเอกสาร อิเล็กทรอนิกส์ หรือรูปแบบอื่นใด ที่
                    พนักงานได้รับหรือรับทราบในระหว่างการปฏิบัติหน้าที่ รวมถึงแต่ไม่จำกัดเพียง:</p>
                <div className="ml-6 mt-2">
                    <p>• ข้อมูลส่วนบุคคลของลูกค้าของคู่ค้า/ลูกค้า เช่น ชื่อ-นามสกุล ที่อยู่ เลขบัตรประชาชน เบอร์โทรศัพท์ อีเมล 
                        ข้อมูลทางการเงิน และข้อมูลอื่น ๆ ตามที่กฎหมายคุ้มครองข้อมูลส่วนบุคคลกำหนด</p>
                    <p>• ข้อมูลทางธุรกิจของคู่ค้า/ลูกค้า เช่น แผนธุรกิจ กลยุทธ์ทางการตลาด ราคา เงื่อนไขการค้า โครงสร้าง
                        องค์กร และข้อมูลทางการเงิน</p>
                    <p>• ข้อมูลทางเทคนิค เช่น ซอฟต์แวร์ ฐานข้อมูล การออกแบบ กระบวนการทำงาน และเทคโนโลยีต่าง ๆ</p>
                    <p>• เอกสารทุกประเภทที่ได้รับในระหว่างการทำงาน ไม่ว่าจะเป็นต้นฉบับหรือสำเนา</p>
                </div>
            </div>

            {/* Clause 2.2 */}
            <div className="mb-4 leading-[1.4] text-justify">
                <p>2.2 พนักงานตกลงรับทราบว่า ข้อมูลความลับทั้งหมดเป็นทรัพย์สินของบริษัท และ/หรือคู่ค้า/ลูกค้า และ/หรือ
                    ลูกค้าของคู่ค้า/ลูกค้า โดยพนักงานไม่มีสิทธิใช้ประโยชน์จากข้อมูลดังกล่าวเพื่อประโยชน์ส่วนตัวหรือของบุคคล
                    ภายนอก</p>
            </div>

            {/* Clause 3 */}
            <div className="mb-4 leading-[1.4]">
                <p className="font-bold mb-2">ข้อ 3  ข้อห้ามและข้อผูกพันของพนักงาน</p>
            </div>

            {/* Clause 3.1 */}
            <div className="mb-3 leading-[1.4] text-justify">
                <p>3.1 พนักงานสัญญาว่าจะไม่เปิดเผย เผยแพร่ หรือส่งต่อข้อมูลความลับไปยังบุคคลภายนอก หรือบุคคลที่ไม่ได้รับ
                    อนุญาตจากบริษัท และ/หรือคู่ค้า/ลูกค้า ไม่ว่าในกรณีใด ๆ</p>
            </div>

            {/* Clause 3.2 */}
            <div className="mb-3 leading-[1.4] text-justify">
                <p>3.2 พนักงานสัญญาว่าจะไม่ทำสำเนา ถ่ายภาพ บันทึก หรือทำซ้ำข้อมูลความลับ ไม่ว่าในรูปแบบใด ๆ เว้นแต่
                    จะได้รับอนุญาตเป็นลายลักษณ์อักษรจากบริษัท และ/หรือคู่ค้า/ลูกค้า</p>
            </div>

            {/* Clause 3.3 */}
            <div className="mb-3 leading-[1.4] text-justify">
                <p>3.3 พนักงานต้องไม่นำข้อมูลความลับออกนอกสถานที่ทำงานของบริษัท หรือสถานที่ที่บริษัทและ/หรือคู่ค้า/ลูกค้า
                    กำหนด โดยไม่ได้รับอนุญาตเป็นลายลักษณ์อักษร</p>
            </div>

            {/* Clause 3.4 */}
            <div className="mb-3 leading-[1.4] text-justify">
                <p>3.4 พนักงานต้องไม่ใช้อุปกรณ์อิเล็กทรอนิกส์ส่วนตัว (เช่น โทรศัพท์มือถือ แท็บเล็ต ฯลฯ) เพื่อถ่ายภาพ บันทึก 
                    หรือเก็บข้อมูลความลับ โดยไม่ได้รับอนุญาต</p>
            </div>

            {/* Clause 3.5 */}
            <div className="mb-3 leading-[1.4] text-justify">
                <p>3.5 พนักงานต้องใช้ข้อมูลความลับเพื่อวัตถุประสงค์ในการปฏิบัติงานที่ได้รับมอบหมายเท่านั้น และต้องไม่
                    นำไปใช้เพื่อประโยชน์อื่นใดนอกเหนือจากนี้</p>
            </div>

            {/* Clause 3.6 */}
            <div className="mb-4 leading-[1.4] text-justify">
                <p>3.6 พนักงานต้องไม่พูดคุย หรือเปิดเผยข้อมูลความลับที่ได้รับทราบในระหว่างการทำงาน ไม่ว่าจะเป็นการพูดคุย
                    กับเพื่อนร่วมงาน คนในครอบครัว หรือบุคคลภายนอก โดยเด็ดขาด</p>
            </div>
