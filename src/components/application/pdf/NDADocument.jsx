...
export default function NDADocument({ applicant, formData = {} }) {
    ...
    // Use formData.currentAddress if provided, otherwise fallback to applicant's current_address
    const hasCustomAddress = formData.currentAddress && Object.values(formData.currentAddress).some(v => v);
    const currentAddr = hasCustomAddress ? formData.currentAddress : (p.current_address || {});
