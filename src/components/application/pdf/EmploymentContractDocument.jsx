    ...
    return (
        ...
        >
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p>1.1 ระยะเวลาเริ่มและสิ้นสุดโครงการตั้งแต่วันที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1 ${formData.startDay}`} style={{ verticalAlign: 'baseline', ...(!formData.startDay && { minHeight: '1.2em' }) }}>{formData.startDay || '\u00A0'}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1 ${formData.startMonth}`} style={{ verticalAlign: 'baseline', ...(!formData.startMonth && { minHeight: '1.2em' }) }}>{formData.startMonth || '\u00A0'}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 pb-1 ${formData.startYear}`} style={{ verticalAlign: 'baseline', ...(!formData.startYear && { minHeight: '1.2em' }) }}>{formData.startYear || '\u00A0'}</span> ถึง วันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1 ${formData.endDay}`} style={{ verticalAlign: 'baseline', ...(!formData.endDay && { minHeight: '1.2em' }) }}>{formData.endDay || '\u00A0'}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1 ${formData.endMonth}`} style={{ verticalAlign: 'baseline', ...(!formData.endMonth && { minHeight: '1.2em' }) }}>{formData.endMonth || '\u00A0'}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 pb-1 ${formData.endYear}`} style={{ verticalAlign: 'baseline', ...(!formData.endYear && { minHeight: '1.2em' }) }}>{formData.endYear || '\u00A0'}</span></p>
                <p>1.2 เริ่มต้นปฏิบัติงานในวันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1 ${formData.workStartDay}`} style={{ verticalAlign: 'baseline', ...(!formData.workStartDay && { minHeight: '1.2em' }) }}>{formData.workStartDay || '\u00A0'}</span> เดือน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 pb-1 ${formData.workStartMonth}`} style={{ verticalAlign: 'baseline', ...(!formData.workStartMonth && { minHeight: '1.2em' }) }}>{formData.workStartMonth || '\u00A0'}</span> พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1 ${formData.workStartYear}`} style={{ verticalAlign: 'baseline', ...(!formData.workStartYear && { minHeight: '1.2em' }) }}>{formData.workStartYear || '\u00A0'}</span></p>
