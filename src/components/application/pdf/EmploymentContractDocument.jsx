...
export default function EmploymentContractDocument({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            <div className="mb-4 text-justify leading-[1.4]">
                <p className="indent-8">
                    นาย/นาง/นางสาว<span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 min-h-[1.2em] ${applicant?.full_name ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{applicant?.full_name || '\u00A0'}</span>เลขที่บัตรประชาชน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[160px] text-center px-2 min-h-[1.2em] ${p.id_card ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{p.id_card || '\u00A0'}</span>อยู่
                    บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 min-h-[1.2em] ${(formData.houseNumber || currentAddr.number) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.houseNumber || currentAddr.number || '\u00A0'}</span>หมู่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[50px] text-center px-2 min-h-[1.2em] ${(formData.moo || currentAddr.moo) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.moo || currentAddr.moo || '\u00A0'}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 min-h-[1.2em] ${(formData.soi || currentAddr.soi) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.soi || currentAddr.soi || '\u00A0'}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 min-h-[1.2em] ${(formData.road || currentAddr.road) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.road || currentAddr.road || '\u00A0'}</span>ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 min-h-[1.2em] ${(formData.subdistrict || currentAddr.subdistrict) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.subdistrict || currentAddr.subdistrict || '\u00A0'}</span>อำเภอ/เขต
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 min-h-[1.2em] ${(formData.district || currentAddr.district) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.district || currentAddr.district || '\u00A0'}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 min-h-[1.2em] ${(formData.province || currentAddr.province) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.province || currentAddr.province || '\u00A0'}</span>รหัสไปรษณีย์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 min-h-[1.2em] ${(formData.zipcode || currentAddr.zipcode) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.zipcode || currentAddr.zipcode || '\u00A0'}</span>เบอร์โทรศัพท์มือถือ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 min-h-[1.2em] ${p.mobile_phone ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{p.mobile_phone || '\u00A0'}</span>ซึ่งต่อไปใน
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p>1.1 ระยะเวลาเริ่มและสิ้นสุดโครงการตั้งแต่วันที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 min-h-[1.2em] ${formData.startDay ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.startDay || '\u00A0'}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 min-h-[1.2em] ${formData.startMonth ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.startMonth || '\u00A0'}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 min-h-[1.2em] ${formData.startYear ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.startYear || '\u00A0'}</span> ถึง วันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 min-h-[1.2em] ${formData.endDay ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.endDay || '\u00A0'}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 min-h-[1.2em] ${formData.endMonth ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.endMonth || '\u00A0'}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 min-h-[1.2em] ${formData.endYear ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.endYear || '\u00A0'}</span></p>
                <p>1.2 เริ่มต้นปฏิบัติงานในวันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 min-h-[1.2em] ${formData.workStartDay ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.workStartDay || '\u00A0'}</span> เดือน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 min-h-[1.2em] ${formData.workStartMonth ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.workStartMonth || '\u00A0'}</span> พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 min-h-[1.2em] ${formData.workStartYear ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.workStartYear || '\u00A0'}</span></p>
                ...
                <p>1.4 ในช่วงระหว่างปฏิบัติหน้าที่ เวลาเข้า-ออกงานเวลา <span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 min-h-[1.2em] ${formData.workTimeStart ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.workTimeStart || '\u00A0'}</span>นาฬิกา ถึงเวลา<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 min-h-[1.2em] ${formData.workTimeEnd ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.workTimeEnd || '\u00A0'}</span>นาฬิกา หรือ  เวลา<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 min-h-[1.2em] ${formData.workTimeAlt1 ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.workTimeAlt1 || '\u00A0'}</span>
                    ถึง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 min-h-[1.2em] ${formData.workTimeAlt2 ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.workTimeAlt2 || '\u00A0'}</span>นาฬิกา และ/หรือกะเข้างานตามจริงที่ได้รับมอบหมาย</p>
                <p className="text-justify">1.5 ปฏิบัติหน้าที่ ในตำแหน่ง <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 min-h-[1.2em] ${formData.position ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.position || '\u00A0'}</span>  เพื่อปฏิบัติหน้าที่ตามที่ได้รับมอบหมาย และ/หรือหน้าที่
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p className="text-justify">2.1  ลูกจ้างรายวัน วันละ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 min-h-[1.2em] ${formData.dailyRate ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.dailyRate || '\u00A0'}</span> บาท (<span className={`border-b border-dotted border-slate-400 inline-block min-w-[280px] text-center px-2 min-h-[1.2em] ${formData.dailyRateText ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.dailyRateText || '\u00A0'}</span>บาทถ้วน) และสวัสดิการอื่นๆตามความ
        ...
        >
            ...
            {/* Clause 2.2 */}
            <div className="mb-4 leading-[1.4]">
                <p className="text-justify">2.2  ลูกจ้างรายเดือน เดือนละ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 min-h-[1.2em] ${formData.monthlyRate ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.monthlyRate || '\u00A0'}</span> บาท (<span className={`border-b border-dotted border-slate-400 inline-block min-w-[280px] text-center px-2 min-h-[1.2em] ${formData.monthlyRateText ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.monthlyRateText || '\u00A0'}</span>บาทถ้วน) และสวัสดิการอื่นๆตามความ
                    เหมาะสม(ถ้ามี) ทั้งนี้ ลูกจ้างตกลงยินยอมให้บริษัทฯนำเงินค่าจ้างของลูกจ้างเพื่อนำไปส่งเงินสมทบประกันสังคม และเงินภาษีอื่นๆ(ถ้ามี) 
                    ชำระตามอัตราที่กฎหมายกำหนด ก่อนทำจ่ายค่าจ้างให้แก่ลูกจ้างทุกๆเดือน โดยบริษัทฯไม่ต้องบอกกล่าวล่วงหน้า</p>
            </div>
            ...
            <div className="mb-4 leading-[1.4] text-justify">
                <p className="mb-2">2.3 ในการดำเนินการจ่ายค่าตอบแทนการทำงานให้แก่ลูกจ้างตามข้อ 2.1 และข้อ 2.2 บริษัทฯตกลงที่จะจ่ายค่าตอบแทนการ
                    ...
                    ค่าจ้างจะออกวันศุกร์ ทั้งนี้ปฏิทินในแต่ละเดือนจำนวนวันไม่เท่ากัน เพราะฉะนั้นให้ถือเป็นวันสุดท้ายของวันสิ้นเดือนในเดือนนั้นๆ โดยลูกจ้างตกลงยินยอมให้บริษัทฯจ่ายค่าตอบแทนการทำงานให้แก่ลูกจ้างโดยวิธีการโอนเงินผ่านบัญชีธนาคาร<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 min-h-[1.2em] ${formData.bankName ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.bankName || '\u00A0'}</span>บัญชีเลขที่ 
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 min-h-[1.2em] ${formData.accountNumber ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.accountNumber || '\u00A0'}</span> ชื่อบัญชี <span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 min-h-[1.2em] ${formData.accountName ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.accountName || '\u00A0'}</span> และ/หรือจ่ายค่าตอบแทนการทำงานโดย
            ...
            <div className="mb-4 leading-[1.4] text-justify">
                <p className="mb-2">2.4 คู่สัญญาทั้งสองฝ่ายตกลงว่า เพื่อมิให้การดำเนินกิจการของบริษัทฯหยุดชะงัก และ/หรือเกิดความเสียหายใดๆที่อาจเกิดขึ้นได้
                    ...
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 min-h-[1.2em] ${formData.checkAccountName ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.checkAccountName || '\u00A0'}</span> ให้กับลูกจ้างเข้ามารับเช็คดังกล่าว ณ ที่ทำการของบริษัทฯด้วยตนเองในวันและเวลา
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p className="mb-2">3.1 ระยะเวลาการทดลองงาน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 min-h-[1.2em] ${formData.probationDays ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline' }}>{formData.probationDays || '\u00A0'}</span>วัน  และ/หรือระยะเวลาการประเมินตามเงื่อนไขของบริษัทฯ</p>
