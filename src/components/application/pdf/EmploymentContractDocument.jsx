...
export default function EmploymentContractDocument({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            <div className="mb-4 text-justify leading-[1.4]">
                <p className="indent-8">
                    นาย/นาง/นางสาว<span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || ''}</span>เลขที่บัตรประชาชน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[160px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || ''}</span>อยู่
                    บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.houseNumber || currentAddr.number)) && { minHeight: '1.2em' }) }}>{formData.houseNumber || currentAddr.number || ''}</span>หมู่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[50px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.moo || currentAddr.moo)) && { minHeight: '1.2em' }) }}>{formData.moo || currentAddr.moo || ''}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.soi || currentAddr.soi)) && { minHeight: '1.2em' }) }}>{formData.soi || currentAddr.soi || ''}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.road || currentAddr.road)) && { minHeight: '1.2em' }) }}>{formData.road || currentAddr.road || ''}</span>ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.subdistrict || currentAddr.subdistrict)) && { minHeight: '1.2em' }) }}>{formData.subdistrict || currentAddr.subdistrict || ''}</span>อำเภอ/เขต
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.district || currentAddr.district)) && { minHeight: '1.2em' }) }}>{formData.district || currentAddr.district || ''}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.province || currentAddr.province)) && { minHeight: '1.2em' }) }}>{formData.province || currentAddr.province || ''}</span>รหัสไปรษณีย์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!((formData.zipcode || currentAddr.zipcode)) && { minHeight: '1.2em' }) }}>{formData.zipcode || currentAddr.zipcode || ''}</span>เบอร์โทรศัพท์มือถือ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!p.mobile_phone && { minHeight: '1.2em' }) }}>{p.mobile_phone || ''}</span>ซึ่งต่อไปใน
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p>1.1 ระยะเวลาเริ่มและสิ้นสุดโครงการตั้งแต่วันที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.startDay && { minHeight: '1.2em' }) }}>{formData.startDay || ''}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.startMonth && { minHeight: '1.2em' }) }}>{formData.startMonth || ''}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.startYear && { minHeight: '1.2em' }) }}>{formData.startYear || ''}</span> ถึง วันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.endDay && { minHeight: '1.2em' }) }}>{formData.endDay || ''}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.endMonth && { minHeight: '1.2em' }) }}>{formData.endMonth || ''}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.endYear && { minHeight: '1.2em' }) }}>{formData.endYear || ''}</span></p>
                <p>1.2 เริ่มต้นปฏิบัติงานในวันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.workStartDay && { minHeight: '1.2em' }) }}>{formData.workStartDay || ''}</span> เดือน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.workStartMonth && { minHeight: '1.2em' }) }}>{formData.workStartMonth || ''}</span> พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.workStartYear && { minHeight: '1.2em' }) }}>{formData.workStartYear || ''}</span></p>
                ...
                <p>1.4 ในช่วงระหว่างปฏิบัติหน้าที่ เวลาเข้า-ออกงานเวลา <span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeStart && { minHeight: '1.2em' }) }}>{formData.workTimeStart || ''}</span>นาฬิกา ถึงเวลา<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeEnd && { minHeight: '1.2em' }) }}>{formData.workTimeEnd || ''}</span>นาฬิกา หรือ  เวลา<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeAlt1 && { minHeight: '1.2em' }) }}>{formData.workTimeAlt1 || ''}</span>
                    ถึง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeAlt2 && { minHeight: '1.2em' }) }}>{formData.workTimeAlt2 || ''}</span>นาฬิกา และ/หรือกะเข้างานตามจริงที่ได้รับมอบหมาย</p>
                <p className="text-justify">1.5 ปฏิบัติหน้าที่ ในตำแหน่ง <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.position && { minHeight: '1.2em' }) }}>{formData.position || ''}</span>  เพื่อปฏิบัติหน้าที่ตามที่ได้รับมอบหมาย และ/หรือหน้าที่
                ...
                <p className="text-justify">1.6 สังกัดหน่วยงาน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.department && { minHeight: '1.2em' }) }}>{formData.department || ''}</span>แผนก/ฝ่าย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.division && { minHeight: '1.2em' }) }}>{formData.division || ''}</span></p>
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p className="text-justify">2.1  ลูกจ้างรายวัน วันละ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.dailyRate && { minHeight: '1.2em' }) }}>{formData.dailyRate || ''}</span> บาท (<span className={`border-b border-dotted border-slate-400 inline-block min-w-[280px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.dailyRateText && { minHeight: '1.2em' }) }}>{formData.dailyRateText || ''}</span>บาทถ้วน) และสวัสดิการอื่นๆตามความ
        ...
        >
            ...
            {/* Clause 2.2 */}
            <div className="mb-4 leading-[1.4]">
                <p className="text-justify">2.2  ลูกจ้างรายเดือน เดือนละ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.monthlyRate && { minHeight: '1.2em' }) }}>{formData.monthlyRate || ''}</span> บาท (<span className={`border-b border-dotted border-slate-400 inline-block min-w-[280px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.monthlyRateText && { minHeight: '1.2em' }) }}>{formData.monthlyRateText || ''}</span>บาทถ้วน) และสวัสดิการอื่นๆตามความ
                    เหมาะสม(ถ้ามี) ทั้งนี้ ลูกจ้างตกลงยินยอมให้บริษัทฯนำเงินค่าจ้างของลูกจ้างเพื่อนำไปส่งเงินสมทบประกันสังคม และเงินภาษีอื่นๆ(ถ้ามี) 
                    ชำระตามอัตราที่กฎหมายกำหนด ก่อนทำจ่ายค่าจ้างให้แก่ลูกจ้างทุกๆเดือน โดยบริษัทฯไม่ต้องบอกกล่าวล่วงหน้า</p>
            </div>
            ...
            <div className="mb-4 leading-[1.4] text-justify">
                <p className="mb-2">2.3 ในการดำเนินการจ่ายค่าตอบแทนการทำงานให้แก่ลูกจ้างตามข้อ 2.1 และข้อ 2.2 บริษัทฯตกลงที่จะจ่ายค่าตอบแทนการ
                    ...
                    ค่าจ้างจะออกวันศุกร์ ทั้งนี้ปฏิทินในแต่ละเดือนจำนวนวันไม่เท่ากัน เพราะฉะนั้นให้ถือเป็นวันสุดท้ายของวันสิ้นเดือนในเดือนนั้นๆ โดยลูกจ้างตกลงยินยอมให้บริษัทฯจ่ายค่าตอบแทนการทำงานให้แก่ลูกจ้างโดยวิธีการโอนเงินผ่านบัญชีธนาคาร<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.bankName && { minHeight: '1.2em' }) }}>{formData.bankName || ''}</span>บัญชีเลขที่ 
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.accountNumber && { minHeight: '1.2em' }) }}>{formData.accountNumber || ''}</span> ชื่อบัญชี <span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.accountName && { minHeight: '1.2em' }) }}>{formData.accountName || ''}</span> และ/หรือจ่ายค่าตอบแทนการทำงานโดย
            ...
            <div className="mb-4 leading-[1.4] text-justify">
                <p className="mb-2">2.4 คู่สัญญาทั้งสองฝ่ายตกลงว่า เพื่อมิให้การดำเนินกิจการของบริษัทฯหยุดชะงัก และ/หรือเกิดความเสียหายใดๆที่อาจเกิดขึ้นได้
                    ...
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.checkAccountName && { minHeight: '1.2em' }) }}>{formData.checkAccountName || ''}</span> ให้กับลูกจ้างเข้ามารับเช็คดังกล่าว ณ ที่ทำการของบริษัทฯด้วยตนเองในวันและเวลา
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p className="mb-2">3.1 ระยะเวลาการทดลองงาน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.probationDays && { minHeight: '1.2em' }) }}>{formData.probationDays || ''}</span>วัน  และ/หรือระยะเวลาการประเมินตามเงื่อนไขของบริษัทฯ</p>
