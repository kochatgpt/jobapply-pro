...
export default function EmploymentContractDocument({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            <div className="mb-4 text-justify leading-[1.4]">
                <p className="indent-8">
                    นาย/นาง/นางสาว<span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 pb-1 ${applicant?.full_name}`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || ''}</span>เลขที่บัตรประชาชน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[160px] text-center px-2 pb-1${p.id_card ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || ''}</span>อยู่
                    บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1 ${(formData.houseNumber || currentAddr.number) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.houseNumber || currentAddr.number) && { minHeight: '1.2em' }) }}>{formData.houseNumber || currentAddr.number || ''}</span>หมู่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[50px] text-center px-2 pb-1 ${(formData.moo || currentAddr.moo) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.moo || currentAddr.moo) && { minHeight: '1.2em' }) }}>{formData.moo || currentAddr.moo || ''}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1 ${(formData.soi || currentAddr.soi) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.soi || currentAddr.soi) && { minHeight: '1.2em' }) }}>{formData.soi || currentAddr.soi || ''}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${(formData.road || currentAddr.road) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.road || currentAddr.road) && { minHeight: '1.2em' }) }}>{formData.road || currentAddr.road || ''}</span>ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${(formData.subdistrict || currentAddr.subdistrict) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.subdistrict || currentAddr.subdistrict) && { minHeight: '1.2em' }) }}>{formData.subdistrict || currentAddr.subdistrict || ''}</span>อำเภอ/เขต
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${(formData.district || currentAddr.district) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.district || currentAddr.district) && { minHeight: '1.2em' }) }}>{formData.district || currentAddr.district || ''}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${(formData.province || currentAddr.province) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.province || currentAddr.province) && { minHeight: '1.2em' }) }}>{formData.province || currentAddr.province || ''}</span>รหัสไปรษณีย์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1 ${(formData.zipcode || currentAddr.zipcode) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.zipcode || currentAddr.zipcode) && { minHeight: '1.2em' }) }}>{formData.zipcode || currentAddr.zipcode || ''}</span>เบอร์โทรศัพท์มือถือ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 pb-1 ${p.mobile_phone ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.mobile_phone && { minHeight: '1.2em' }) }}>{p.mobile_phone || ''}</span>ซึ่งต่อไปใน
