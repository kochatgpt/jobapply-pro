...
export default function EmploymentContractDocument({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            <div className="mb-4 text-justify leading-[1.4]">
                <p className="indent-8">
                    นาย/นาง/นางสาว<span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 ${applicant?.full_name ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || ''}</span>เลขที่บัตรประชาชน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[160px] text-center px-2 ${p.id_card ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || ''}</span>อยู่
                    บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 ${(formData.houseNumber || currentAddr.number) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.houseNumber || currentAddr.number) && { minHeight: '1.2em' }) }}>{formData.houseNumber || currentAddr.number || ''}</span>หมู่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[50px] text-center px-2 ${(formData.moo || currentAddr.moo) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.moo || currentAddr.moo) && { minHeight: '1.2em' }) }}>{formData.moo || currentAddr.moo || ''}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 ${(formData.soi || currentAddr.soi) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.soi || currentAddr.soi) && { minHeight: '1.2em' }) }}>{formData.soi || currentAddr.soi || ''}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${(formData.road || currentAddr.road) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.road || currentAddr.road) && { minHeight: '1.2em' }) }}>{formData.road || currentAddr.road || ''}</span>ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${(formData.subdistrict || currentAddr.subdistrict) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.subdistrict || currentAddr.subdistrict) && { minHeight: '1.2em' }) }}>{formData.subdistrict || currentAddr.subdistrict || ''}</span>อำเภอ/เขต
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${(formData.district || currentAddr.district) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.district || currentAddr.district) && { minHeight: '1.2em' }) }}>{formData.district || currentAddr.district || ''}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${(formData.province || currentAddr.province) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.province || currentAddr.province) && { minHeight: '1.2em' }) }}>{formData.province || currentAddr.province || ''}</span>รหัสไปรษณีย์<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${(formData.zipcode || currentAddr.zipcode) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.zipcode || currentAddr.zipcode) && { minHeight: '1.2em' }) }}>{formData.zipcode || currentAddr.zipcode || ''}</span>เบอร์โทรศัพท์มือถือ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 ${p.mobile_phone ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.mobile_phone && { minHeight: '1.2em' }) }}>{p.mobile_phone || ''}</span>ซึ่งต่อไปใน
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p>1.1 ระยะเวลาเริ่มและสิ้นสุดโครงการตั้งแต่วันที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 ${formData.startDay ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.startDay && { minHeight: '1.2em' }) }}>{formData.startDay || ''}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${formData.startMonth ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.startMonth && { minHeight: '1.2em' }) }}>{formData.startMonth || ''}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 ${formData.startYear ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.startYear && { minHeight: '1.2em' }) }}>{formData.startYear || ''}</span> ถึง วันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 ${formData.endDay ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.endDay && { minHeight: '1.2em' }) }}>{formData.endDay || ''}</span>เดือน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${formData.endMonth ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.endMonth && { minHeight: '1.2em' }) }}>{formData.endMonth || ''}</span>พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 ${formData.endYear ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.endYear && { minHeight: '1.2em' }) }}>{formData.endYear || ''}</span></p>
                <p>1.2 เริ่มต้นปฏิบัติงานในวันที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 ${formData.workStartDay ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.workStartDay && { minHeight: '1.2em' }) }}>{formData.workStartDay || ''}</span> เดือน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 ${formData.workStartMonth ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.workStartMonth && { minHeight: '1.2em' }) }}>{formData.workStartMonth || ''}</span> พ.ศ.<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${formData.workStartYear ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.workStartYear && { minHeight: '1.2em' }) }}>{formData.workStartYear || ''}</span></p>
                ...
                <p>1.4 ในช่วงระหว่างปฏิบัติหน้าที่ เวลาเข้า-ออกงานเวลา <span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${formData.workTimeStart ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeStart && { minHeight: '1.2em' }) }}>{formData.workTimeStart || ''}</span>นาฬิกา ถึงเวลา<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${formData.workTimeEnd ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeEnd && { minHeight: '1.2em' }) }}>{formData.workTimeEnd || ''}</span>นาฬิกา หรือ  เวลา<span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 ${formData.workTimeAlt1 ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeAlt1 && { minHeight: '1.2em' }) }}>{formData.workTimeAlt1 || ''}</span>
                    ถึง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 ${formData.workTimeAlt2 ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.workTimeAlt2 && { minHeight: '1.2em' }) }}>{formData.workTimeAlt2 || ''}</span>นาฬิกา และ/หรือกะเข้างานตามจริงที่ได้รับมอบหมาย</p>
                <p className="text-justify">1.5 ปฏิบัติหน้าที่ ในตำแหน่ง <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 ${formData.position ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.position && { minHeight: '1.2em' }) }}>{formData.position || ''}</span>  เพื่อปฏิบัติหน้าที่ตามที่ได้รับมอบหมาย และ/หรือหน้าที่
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p className="text-justify">2.1  ลูกจ้างรายวัน วันละ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 ${formData.dailyRate ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.dailyRate && { minHeight: '1.2em' }) }}>{formData.dailyRate || ''}</span> บาท (<span className={`border-b border-dotted border-slate-400 inline-block min-w-[280px] text-center px-2 ${formData.dailyRateText ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.dailyRateText && { minHeight: '1.2em' }) }}>{formData.dailyRateText || ''}</span>บาทถ้วน) และสวัสดิการอื่นๆตามความ
        ...
        >
            ...
            {/* Clause 2.2 */}
            <div className="mb-4 leading-[1.4]">
                <p className="text-justify">2.2  ลูกจ้างรายเดือน เดือนละ<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 ${formData.monthlyRate ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.monthlyRate && { minHeight: '1.2em' }) }}>{formData.monthlyRate || ''}</span> บาท (<span className={`border-b border-dotted border-slate-400 inline-block min-w-[280px] text-center px-2 ${formData.monthlyRateText ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.monthlyRateText && { minHeight: '1.2em' }) }}>{formData.monthlyRateText || ''}</span>บาทถ้วน) และสวัสดิการอื่นๆตามความ
                    เหมาะสม(ถ้ามี) ทั้งนี้ ลูกจ้างตกลงยินยอมให้บริษัทฯนำเงินค่าจ้างของลูกจ้างเพื่อนำไปส่งเงินสมทบประกันสังคม และเงินภาษีอื่นๆ(ถ้ามี) 
                    ชำระตามอัตราที่กฎหมายกำหนด ก่อนทำจ่ายค่าจ้างให้แก่ลูกจ้างทุกๆเดือน โดยบริษัทฯไม่ต้องบอกกล่าวล่วงหน้า</p>
            </div>
            ...
            <div className="mb-4 leading-[1.4] text-justify">
                <p className="mb-2">2.4 คู่สัญญาทั้งสองฝ่ายตกลงว่า เพื่อมิให้การดำเนินกิจการของบริษัทฯหยุดชะงัก และ/หรือเกิดความเสียหายใดๆที่อาจเกิดขึ้นได้
                    ...
                    <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 ${formData.checkAccountName ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.checkAccountName && { minHeight: '1.2em' }) }}>{formData.checkAccountName || ''}</span> ให้กับลูกจ้างเข้ามารับเช็คดังกล่าว ณ ที่ทำการของบริษัทฯด้วยตนเองในวันและเวลา
            ...
            <div className="mb-4 leading-[1.4]">
                ...
                <p className="mb-2">3.1 ระยะเวลาการทดลองงาน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 ${formData.probationDays ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.probationDays && { minHeight: '1.2em' }) }}>{formData.probationDays || ''}</span>วัน  และ/หรือระยะเวลาการประเมินตามเงื่อนไขของบริษัทฯ</p>
        ...
        >
            ...
            <div className="mb-4 leading-[1.4]">
                <p>ทำที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[400px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>
                <p>วันที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[400px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>
            </div>
            ...
            <div className="mb-4 leading-[1.4] text-justify">
                ...
                <p>ออกให้โดย<span className="border-b border-dotted border-slate-400 inline-block min-w-[400px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>
                <p>วันหมดอายุ<span className="border-b border-dotted border-slate-400 inline-block min-w-[380px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>ขอมอบอำนาจให้บริษัท เค แอนด์ โอ ซิสเต็มส์ แอนด์ คอนซัลติ้ง จำกัด</p>
                <p>โดย<span className="border-b border-dotted border-slate-400 inline-block min-w-[400px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>บัตรประจำตัวประชาชนเลขที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[180px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span></p>
                <p>ออกให้โดย<span className="border-b border-dotted border-slate-400 inline-block min-w-[250px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>วันหมดอายุ<span className="border-b border-dotted border-slate-400 inline-block min-w-[250px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>ซึ่งเป็นผู้มีอำนาจลงนามผูกพันบริษัท</p>
                ...
                <p className="indent-8">ให้หนังสือมอบอำนาจฉบับนี้มีผลเริ่มใช้บังคับตั้งแต่วันที่<span className="border-b border-dotted border-slate-400 inline-block min-w-[200px] mx-2" style={{ verticalAlign: 'baseline', minHeight: '1.2em' }}>&nbsp;</span>เป็นต้นไป จนกว่าการดำเนินการกับเรื่องดังกล่าวข้างต้นในครั้งนี้จะเสร็จการ ซึ่งการใด ๆ ที่ผู้รับมอบอำนาจได้กระทำภายใต้เงื่อนไขหนังสือมอบอำนาจฉบับนี้ ให้มีผลผูกพันผู้มอบอำนาจ เสมือนหนึ่งว่าผู้มอบอำนาจ ได้กระทำการดังกล่าวด้วยตนเองทุกประการ เพื่อเป็นหลักฐานแห่งการนี้ จึงได้ลงลายมือชื่อในหนังสือมอบอำนาจฉบับนี้ไว้ต่อหน้าพยานเป็นสำคัญ</p>
            </div>
        ...
        {/* Page 10 - Consent for Criminal Record Check */}
        <div 
            className="pdpa-page bg-white text-slate-900 mx-auto relative text-[12px] font-sans p-[20mm] shadow-sm print:shadow-none mt-8"
            style={{ 
                width: '210mm', 
        ...
        >
            ...
            <div className="mb-4 leading-[1.4] text-justify">
                ...
                <p>อยู่บ้านเลขที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 mx-2 ${(formData.houseNumber || currentAddr.number) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.houseNumber || currentAddr.number) && { minHeight: '1.2em' }) }}>{formData.houseNumber || currentAddr.number || '\u00A0'}</span>หมู่ที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 mx-2 ${(formData.moo || currentAddr.moo) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.moo || currentAddr.moo) && { minHeight: '1.2em' }) }}>{formData.moo || currentAddr.moo || '\u00A0'}</span>ซอย<span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 mx-2 ${(formData.soi || currentAddr.soi) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.soi || currentAddr.soi) && { minHeight: '1.2em' }) }}>{formData.soi || currentAddr.soi || '\u00A0'}</span>ถนน<span className={`border-b border-dotted border-slate-400 inline-block min-w-[140px] text-center px-2 mx-2 ${(formData.road || currentAddr.road) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.road || currentAddr.road) && { minHeight: '1.2em' }) }}>{formData.road || currentAddr.road || '\u00A0'}</span></p>
                <p>ตำบล/แขวง<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 mx-2 ${(formData.subdistrict || currentAddr.subdistrict) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.subdistrict || currentAddr.subdistrict) && { minHeight: '1.2em' }) }}>{formData.subdistrict || currentAddr.subdistrict || '\u00A0'}</span>อำเภอ/เขต<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 mx-2 ${(formData.district || currentAddr.district) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.district || currentAddr.district) && { minHeight: '1.2em' }) }}>{formData.district || currentAddr.district || '\u00A0'}</span>จังหวัด<span className={`border-b border-dotted border-slate-400 inline-block min-w-[180px] text-center px-2 mx-2 ${(formData.province || currentAddr.province) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((formData.province || currentAddr.province) && { minHeight: '1.2em' }) }}>{formData.province || currentAddr.province || '\u00A0'}</span></p>
