...
export default function SPS902Document({ applicant, formData = {} }) {
    ...
    return (
        ...
        >
            ...
            <div className="border border-slate-900">
                ...
                <div className="grid grid-cols-5 gap-0 divide-x divide-slate-900">
                    ...
                    <div className="col-span-2 border-slate-900">
                        <div className="text-xs font-bold px-3 pb-2 mr-28 pt-1 border-b border-r border-slate-900">
            ...
            <div className="border border-slate-900">
                <div className="border-b border-slate-900 px-2 py-1 font-bold text-sm">
            ...
            <div className="border border-slate-900">
                <div className="border-b border-slate-900 px-2 py-1 font-bold text-sm text-center">
                    สำหรับเจ้าหน้าที่
                </div>
