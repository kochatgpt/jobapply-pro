                ...
                <div className="px-3 text-xs space-y-1">
                    ...
                    <div className="grid justify-end items-end pt-1 gap-1">
                        ...
                        <div className="flex items-center gap-1 text-xs mb-0.5">
                            <span>ลงวันที่</span>
                            <span className={`border-b border-dotted border-slate-400 inline-block w-8 text-center px-1 pb-0.5`} style={{ minHeight: '1.2em' }}>{formData.declarationSignatureDate ? new Date(formData.declarationSignatureDate).toLocaleDateString('th-TH').split('/')[0] : '\u00A0'}</span>
                            <span>เดือน</span>
                            <span className={`border-b border-dotted border-slate-400 inline-block w-20 text-center px-1 pb-0.5`} style={{ minHeight: '1.2em' }}>{formData.declarationSignatureDate ? new Date(formData.declarationSignatureDate).toLocaleDateString('th-TH').split('/')[1] : '\u00A0'}</span>
                            <span>พ.ศ.</span>
                            <span className={`border-b border-dotted border-slate-400 inline-block w-8 text-center px-1 pb-0.5`} style={{ minHeight: '1.2em' }}>{formData.declarationSignatureDate ? (new Date(formData.declarationSignatureDate).getFullYear() + 543) : '\u00A0'}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="px-3 py-0.5">
                    ...
                    <div className="grid justify-end items-end pt-0.5 gap-1">
                        ...
                        <div className="flex items-center gap-1 text-xs mb-1">
                             ...
                             <div className={`border-b border-dotted border-slate-400 inline-block w-8 text-center px-1 pb-0.5`} style={{ minHeight: '1.2em' }}>{formData.staffSignatureDate ? new Date(formData.staffSignatureDate).toLocaleDateString('th-TH').split('/')[0] : '\u00A0'}</div>
                             <div className="text-xs">เดือน</div>
                             <div className={`border-b border-dotted border-slate-400 inline-block w-20 text-center px-1 pb-0.5`} style={{ minHeight: '1.2em' }}>{formData.staffSignatureDate ? new Date(formData.staffSignatureDate).toLocaleDateString('th-TH').split('/')[1] : '\u00A0'}</div>
                             <div className="text-xs">พ.ศ.</div>
                             <div className={`border-b border-dotted border-slate-400 inline-block w-8 text-center px-1 pb-0.5`} style={{ minHeight: '1.2em' }}>{formData.staffSignatureDate ? (new Date(formData.staffSignatureDate).getFullYear() + 543) : '\u00A0'}</div>
                         </div>
                    </div>
                </div>
            </div>
