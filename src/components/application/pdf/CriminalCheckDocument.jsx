    ...
    return (
        ...
        >
            ...
            <div className="space-y-2 text-justify">
                <p>
                    ข้าพเจ้า <span className={`border-b border-dotted border-slate-400 inline-block min-w-[450px] text-center px-2 ${applicant?.full_name ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || '\u00A0'}</span> บัตรประจำตัวประชาชนเลขที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${p.id_card ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || '\u00A0'}</span>
                </p>
                <p>
                    ออกให้โดย <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 ${formData.idIssuedBy ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.idIssuedBy && { minHeight: '1.2em' }) }}>{formData.idIssuedBy || '\u00A0'}</span> วันหมดอายุ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${formData.idExpiry ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...(!formData.idExpiry && { minHeight: '1.2em' }) }}>{formData.idExpiry || '\u00A0'}</span>
                </p>
                <p>
                    ขอมอบอำนาจให้บริษัท <span className={`border-b border-dotted border-slate-400 inline-block min-w-[500px] text-center px-2 ${(companyData.companyName || formData.companyName) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((companyData.companyName || formData.companyName) && { minHeight: '1.2em' }) }}>{companyData.companyName || formData.companyName || '\u00A0'}</span>
                </p>
                <p>
                    โดย <span className={`border-b border-dotted border-slate-400 inline-block min-w-[400px] text-center px-2 ${(companyData.authorizedPerson || formData.authorizedPerson) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((companyData.authorizedPerson || formData.authorizedPerson) && { minHeight: '1.2em' }) }}>{companyData.authorizedPerson || formData.authorizedPerson || '\u00A0'}</span> บัตรประจำตัวประชาชนเลขที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${(companyData.authorizedId || formData.authorizedId) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((companyData.authorizedId || formData.authorizedId) && { minHeight: '1.2em' }) }}>{companyData.authorizedId || formData.authorizedId || '\u00A0'}</span>
                </p>
                <p>
                    ออกให้โดย <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${(companyData.authIdIssuedBy || formData.authIdIssuedBy) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((companyData.authIdIssuedBy || formData.authIdIssuedBy) && { minHeight: '1.2em' }) }}>{companyData.authIdIssuedBy || formData.authIdIssuedBy || '\u00A0'}</span> วันหมดอายุ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 ${(companyData.authIdExpiry || formData.authIdExpiry) ? 'pb-1' : ''}`} style={{ verticalAlign: 'baseline', ...((companyData.authIdExpiry || formData.authIdExpiry) && { minHeight: '1.2em' }) }}>{companyData.authIdExpiry || formData.authIdExpiry || '\u00A0'}</span> ซึ่งเป็นผู้มีอำนาจลงนามผูกพันบริษัท
                </p>
