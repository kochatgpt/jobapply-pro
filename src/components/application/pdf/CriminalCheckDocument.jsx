    ...
    return (
        ...
        >
            ...
            <div className="space-y-2 text-justify leading-tight">
                <p>
                    ข้าพเจ้า<span className={`border-b border-dotted border-slate-400 inline-block min-w-[400px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || '\u00A0'}</span> บัตรประจำตัวประชาชนเลขที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[250px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || '\u00A0'}</span> ออกให้โดย <span className={`border-b border-dotted border-slate-400 inline-block min-w-[320px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.idIssuedBy && { minHeight: '1.2em' }) }}>{formData.idIssuedBy || '\u00A0'}</span> วันหมดอายุ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[130px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.idExpiry && { minHeight: '1.2em' }) }}>{formData.idExpiry || '\u00A0'}</span> ขอมอบอำนาจให้บริษัท <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.companyName && !formData.companyName && { minHeight: '1.2em' }) }}>{companyData.companyName || formData.companyName || '\u00A0'}</span> โดย <span className={`border-b border-dotted border-slate-400 inline-block min-w-[230px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.authorizedPerson && !formData.authorizedPerson && { minHeight: '1.2em' }) }}>{companyData.authorizedPerson || formData.authorizedPerson || '\u00A0'}</span> บัตรประจำตัวประชาชนเลขที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[190px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.authorizedId && !formData.authorizedId && { minHeight: '1.2em' }) }}>{companyData.authorizedId || formData.authorizedId || '\u00A0'}</span> ออกให้โดย <span className={`border-b border-dotted border-slate-400 inline-block min-w-[210px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.authIdIssuedBy && !formData.authIdIssuedBy && { minHeight: '1.2em' }) }}>{companyData.authIdIssuedBy || formData.authIdIssuedBy || '\u00A0'}</span> วันหมดอายุ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[100px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.authIdExpiry && !formData.authIdExpiry && { minHeight: '1.2em' }) }}>{companyData.authIdExpiry || formData.authIdExpiry || '\u00A0'}</span> ซึ่งเป็นผู้มีอำนาจลงนามผูกพันบริษัทให้กระทำการแทนในการติดต่อ ชี้แจง ยื่น ส่ง เอกสารที่เกี่ยวกับหนังสือขอตรวจสอบประวัติอาชญากรรม หนังสือยินยอมตรวจสอบประวัติอาชญากรรม และรับเอกสารผลการตรวจสอบประวัติอาชญากรรมของข้าพเจ้า กับกองทะเบียนประวัติอาชญากร สำนักงานตำรวจแห่งชาติ ตลอดจนการมอบอำนาจช่วงและดำเนินการอื่นใดในส่วนที่เกี่ยวข้องกับเรื่องดังกล่าวข้างต้นแทนข้าพเจ้าจนเสร็จการ
                </p>
                <p className="indent-8">
                    
                </p>
                <p className="indent-8">
                    ให้หนังสือมอบอำนาจฉบับนี้มีผลเริ่มใช้บังคับตั้งแต่วันที่<span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.effectiveDate && !formData.effectiveDate && { minHeight: '1.2em' }) }}>{companyData.effectiveDate || formData.effectiveDate || '\u00A0'}</span>เป็นต้นไป จนกว่าการดำเนินการกับเรื่องดังกล่าวข้างต้นในครั้งนี้จะเสร็จการซึ่งการใดๆที่ผู้รับมอบอำนาจได้กระทำภายใต้เงื่อนไขหนังสือมอบอำนาจฉบับนี้ ให้มีผลผูกพันผู้มอบอำนาญเสมือนหนึ่งว่าผู้มอบอำนาจ ได้กระทำการดังกล่าวด้วยตนเองทุกประการเพื่อเป็นหลักฐานแห่งการนี้จึงได้ลงลายมือชื่อในหนังสือมอบอำนาจฉบับนี้ไว้ต่อหน้าพยานเป็นสำคัญ
                </p>
            </div>
            ...
            <div className="space-y-2 text-justify leading-tight mt-2">
                ...
                <p>
                    ข้าพเจ้า (นาย/นาง/น.ส.) <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!applicant?.full_name && { minHeight: '1.2em' }) }}>{applicant?.full_name || '\u00A0'}</span> บัตรประจำตัวประชาชนเลขที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!p.id_card && { minHeight: '1.2em' }) }}>{p.id_card || '\u00A0'}</span> อยู่บ้านเลขที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[80px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.houseNumber && !p.current_address?.number && { minHeight: '1.2em' }) }}>{formData.houseNumber || p.current_address?.number || '\u00A0'}</span> หมู่ที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[60px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.moo && !p.current_address?.moo && { minHeight: '1.2em' }) }}>{formData.moo || p.current_address?.moo || '\u00A0'}</span> ซอย <span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.soi && !p.current_address?.soi && { minHeight: '1.2em' }) }}>{formData.soi || p.current_address?.soi || '\u00A0'}</span> ถนน <span className={`border-b border-dotted border-slate-400 inline-block min-w-[120px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.road && !p.current_address?.road && { minHeight: '1.2em' }) }}>{formData.road || p.current_address?.road || '\u00A0'}</span> ตำบล/แขวง <span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.subdistrict && !p.current_address?.subdistrict && { minHeight: '1.2em' }) }}>{formData.subdistrict || p.current_address?.subdistrict || '\u00A0'}</span> อำเภอ/เขต <span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.district && !p.current_address?.district && { minHeight: '1.2em' }) }}>{formData.district || p.current_address?.district || '\u00A0'}</span> จังหวัด <span className={`border-b border-dotted border-slate-400 inline-block min-w-[150px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.province && !p.current_address?.province && { minHeight: '1.2em' }) }}>{formData.province || p.current_address?.province || '\u00A0'}</span> โทรศัพท์ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[200px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!p.mobile_phone && { minHeight: '1.2em' }) }}>{p.mobile_phone || '\u00A0'}</span>
                </p>
                <p>โดยหนังสือฉบับนี้</p>
                <p>
                    ๑. ข้าพเจ้ายินยอมให้ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.companyName && !formData.companyName && { minHeight: '1.2em' }) }}>{companyData.companyName || formData.companyName || '\u00A0'}</span> ซึ่งเป็นหน่วยงานของรัฐหรือบริษัทสำนักงานตั้งอยู่ที่ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[500px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!companyData.companyAddress && !formData.companyAddress && { minHeight: '1.2em' }) }}>{companyData.companyAddress || formData.companyAddress || '\u00A0'}</span> ซึ่งเป็นหน่วยงาน ที่ข้าพเจ้าได้ขออนุญาต หรือสมัครงาน มีสิทธิ์ดำเนินการใด ๆ เข้าตรวจดูข้อมูล ข่าวสารส่วนบุคคล (ประวัติอาชญากรรม) ของข้าพเจ้าเพื่อวัตถุประสงค์ <span className={`border-b border-dotted border-slate-400 inline-block min-w-[300px] text-center px-2 pb-1`} style={{ verticalAlign: 'baseline', ...(!formData.purpose && { minHeight: '1.2em' }) }}>{formData.purpose || '\u00A0'}</span>
                </p>
                <p>
