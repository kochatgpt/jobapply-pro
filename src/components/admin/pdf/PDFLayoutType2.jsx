                ...
                <div className="mt-[5mm] space-y-1">
                    ...
                    <div className="border-[0.5px] border-slate-400 p-2 text-[10px]">
                        ...
                        <div className="text-right space-y-2">
                            ...
                            <div className="flex justify-end items-end gap-2">
                                ...
                                <DottedLine value={applicant.full_name} className="w-[200px] relative top-2 text-center" />
                                <span className="relative top-[1px]">)</span>
                            </div>
                            
                            <div className="flex justify-end items-end gap-2">
                                <span className="relative top-[1px]">วันที่</span>
                                <DottedLine value={applicant.signature_date} className="w-[120px] relative top-2 text-center" />
                            </div>
                            
                            <div className="flex justify-end items-end gap-2">
                                <span className="relative top-[1px]">ข้าพเจ้าพร้อมปฏิบัติงานกับบริษัทฯ ในวันที่</span>
                                <DottedLine value={applicant.start_work_date} className="w-[120px] relative top-2 text-center" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-5 gap-2 text-[9px]">
                        ...
                        <div className="border-[0.5px] border-slate-400 border-l-0 border-t-0 p-2 col-span-2">
                            ...
                            <div className="mb-1">สังกัด/แผนก<DottedLine className="inline-block w-24 ml-1" />รับพิจารณา ตำแหน่ง<DottedLine className="inline-block w-24 ml-1" /></div>
                            <div className="mb-1">อัตราเงินเดือน<DottedLine className="inline-block w-full ml-1" /></div>
