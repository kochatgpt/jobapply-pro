                                ...
                                {[
                                    ...
                                    return (
                                        <tr key={row.k}>
                                            ...
                                            <td className="border-l-[0.5px] border-b-[0.5px] border-slate-400 p-1"><DottedLine value={ed.institute} className=" " /></td>
                                            <td className="border-l-[0.5px] border-b-[0.5px] border-slate-400 p-1"><DottedLine value={ed.major} className="" /></td>
                                            <td className="border-l-[0.5px] border-b-[0.5px] border-slate-400 p-1 text-center"><DottedLine value={ed.start_year} className=" text-center" /></td>
                                            <td className="border-l-[0.5px] border-b-[0.5px] border-slate-400 p-1 text-center"><DottedLine value={ed.end_year} className=" text-center" /></td>
                                            <td className="border-l-[0.5px] border-b-[0.5px] border-r-[0.5px] border-slate-400 p-1 text-center"><DottedLine value={ed.gpa} className=" text-center" /></td>
                                        </tr>
                                    );
                                })}
                            </tbody>
                                ...
                                {[0, 1, 2, 3].map((i) => {
                                    ...
                                    return (
                                        <tr key={i} className="h-[28px]">
                                            ...
                                            <td className="border-[0.5px] border-slate-400 p-1"><DottedLine value={tr.course} className="" /></td>
                                            <td className="border-[0.5px] border-slate-400 p-1"><DottedLine value={tr.institute} className="" /></td>
                                            <td className="border-[0.5px] border-slate-400 p-1 text-center"><DottedLine value={tr.duration} className=" text-center" /></td>
                                        </tr>
                                    );
                                })}
                            </tbody>
