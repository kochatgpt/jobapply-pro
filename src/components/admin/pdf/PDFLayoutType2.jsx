                ...
                <div className="mt-[-15mm] space-y-1">
                    ...
                    <div className="grid grid-cols-3 gap-0 text-[9px]">
                        ...
                        <div className="border-[0.5px] border-slate-400 p-1.5">
                            ...
                            <div className="mb-0.5 text-center">ลงชื่อ<DottedLine className="w-42 relative top-[1px] text-center" /></div>
                            <div className="mb-0.5 text-center">(<DottedLine className="w-42 relative top-[1px] text-center" />)</div>
                            <div className="mb-1 text-center">วันที่<DottedLine className="w-42 relative top-[1px] text-center" /></div>
                        </div>
                        ...
                        <div className="border-[0.5px] border-slate-400 border-l-0 p-1.5">
                            ...
                            <div className="mb-0.5 text-center">ลงชื่อ<DottedLine className="w-42 relative top-[1px] text-center" /></div>
                            <div className="mb-0.5 text-center">(<DottedLine className="w-42 relative top-[1px] text-center" />)</div>
                            <div className="text-center">วันที่<DottedLine className="w-42 relative top-[1px] text-center" /></div>
                        </div>
